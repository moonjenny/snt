			...
			<main id="contents">
				...
				<section class="mainContents">
					...
					<div class="onairGoods">	
						<!-- 동영상 --><!-- 2016-06-17 -->	
						<div class="vod_wrap small"><!-- 클래스 추가 : 기본모드 vod_wrap, 가로모드 vod_wrap full, 하단 축소 모드 vod_wrap small -->
						...
						<div class="onairGoodsIn"><!-- 2016-06-17 : div 추가 -->					
							...
							<div class="btns_wrap btn2">
								<span class="btn with_prd"><a>함께하는 상품 <em>2</em></a></span><!-- 2016-07-29 : 링크 제거 -->
					...
					<div class="goods_list_wrap">
						<div class="goods_wide">
							<div class="goods_img">
								<p class="soldout"><span><em>일시품절</em></span></p><!-- 2016-06-21 : 품절 -->
