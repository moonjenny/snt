			...
			<main id="contents">
				<section class="contents colorContents">
					...
					<div class="details_wrap">
						...
						<!-- 상품정보 -->						
						<div class="goodsName">
							<span>[상품번호 : 10001301] </span>
							<p>2016년형 부라더미싱 신모델 t-3125 [1만원 인하] [BSW파티와이드그릴</p>
						</div>
						<div class="priceInfo">
							<div class="priceInfoIn">
								<dl class="sell">
									<dt><strong>판매가</strong></dt><!-- 2016-07-19 : strong 추가 -->
									<dd>
										<del><span class="price"><em>139,700</em>원</span></del>
									</dd>
								</dl>
								<dl class="sale">
									<dt><strong>쇼핑엔T가</strong><!-- 2016-07-19 : strong 추가 --><span>(<em>100,000</em>원 할인)</span></dt>
									<dd>
										<span class="price"><em>1,268,000</em>원</span>
									</dd>
								</dl>
								<dl class="discount">
									<dt><strong>회원최적가</strong></dt><!-- 2016-07-19 : strong 추가 -->
									<dd>
										<span class="price"><em>1,268,000</em>원</span>
										<span class="btn_detail"><a href="#.">자세히보기</a></span>
									</dd>
								</dl>	
					...
					<div class="details_wrap">
						<div class="toggleView">
							...
							<!-- tab -->
							<div class="screentop_wrap">
								<ul class="tab_group tab_detail ui-tab-btns">
									<li><a class="current" data-tab-target="detail_tab1">상품정보</a></li>
									<li><a class="" data-tab-target="detail_tab2">기본정보</a></li>
									<li><a class="" data-tab-target="detail_tab3">상품평(999)</a></li>
									<li><a class="" data-tab-target="detail_tab4">Q&amp;A(999)</a></li>
								</ul>
							</div>
							<!-- /tab --> 		
												
							<!-- 최외각 div -->
							<div id="detail_tab1" class="ui-tab-content goodsinfo">
								<!-- nodata
							...
							<!-- 2015-05-06 최외각 div 추가 -->
							<div id="detail_tab3" class="ui-tab-content reviews" style="display:none;">
							
								<!-- 상품후기 -->
								<div class="tooggle_box">
									<div class="toggle_tit ui-accordion-btn">
										<p>상품후기 <span class="count">(99)</span><em>&nbsp;</em></p>
									</div>
									<div class="toggle_con">
									
										<div class="hookiView comment">
																												
											<!-- nodata -->
											<p class="list_nodata">등록된 게시물이 없습니다.</p>
											<!-- /nodata -->
											
											<div class="comment_list"><!-- 2015-05-06 class 추가 -->	
												<div>
													<div class="hooki_tit ui-accordion-btn">
														<p>재구매 의사 200% ! 너무 좋아요!!</p>
														<span class="writeInfo">2014.10.31<em>|</em>Frank19**</span>
														<span class="smallStar_inline"><em style="width:100%;"></em></span>
													</div>
													<div class="hooki_con">
														<p>딸아이가 이번에 고등학교에 입학하였습니다. 선물을 사주고 싶어 물어봤더니 카메라가 갖고 싶다고 하네요~딸아이가 이번에 고등학교에 입학하였습니다. 선물을 사주고 싶어 물어봤더니 카메라가 갖고 싶다고 하네요~</p>
														<span class="btn size1 bgcolor1"><a>삭제</a></span>
													</div>
												</div>
												<div>
													<div class="hooki_tit ui-accordion-btn">
														<p>재구매 의사 200% ! 너무 좋아요!!</p>
														<span class="writeInfo">2014.10.31<em>|</em>Frank19**</span>
														<span class="smallStar_inline"><em style="width:80%;"></em></span>
													</div>
													<div class="hooki_con">
														<p>딸아이가 이번에 고등학교에 입학하였습니다. 선물을 사주고 싶어 물어봤더니 카메라가 갖고 싶다고 하네요~딸아이가 이번에 고등학교에 입학하였습니다. 선물을 사주고 싶어 물어봤더니 카메라가 갖고 싶다고 하네요~딸아이가 이번에 고등학교에 입학하였습니다. 선물을 사주고 싶어 물어봤더니 카메라가 갖고 싶다고 하네요~</p>
													</div>													
												</div>												
											</div>
								...
								<!-- 상품후기(식품) -->
								<div class="tooggle_box" style="display:none">
									<div class="toggle_tit ui-accordion-btn">
										<p>상품후기 <span class="count">(99)</span><em>&nbsp;</em></p>
									</div>
									<div class="toggle_con">
										...
										<div class="hookiView comment">		
											...
											<div class="comment_list"><!-- 2015-05-06 class 추가 -->
												...
												<div>
													<div class="hooki_tit">
														<span class="writeInfo">2014.10.31<em>|</em>Frank19**</span>
														<span class="smallStar_inline"><em style="width:0%;"></em></span>
													</div>
												</div>
											</div>
