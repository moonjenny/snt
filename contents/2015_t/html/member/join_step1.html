				...
				<section class="contents"> 
					...
					<form>
						<ol class="step half"><!-- 2016-06-29 : 약관동의 삭제 -->
							<li class="current"><span><u>1</u>가입확인</span></li>
							<li><span><u>2</u>회원정보</span></li>
						</ol>
										...
										<dd>
											<div class="phone_area">
												...
												<p>
													<span>
														<em>-</em>
														<span class="inputBox"><input type="tel" value="0000" name="tel1" autocapitalize="off"  /></span>
													</span>
												</p>
												<p>
													<span>
														<em>-</em>
														<span class="inputBox"><input type="tel" value="0000" name="tel2" autocapitalize="off"  /></span>
													</span>
												</p>
											</div>
										</dd>
