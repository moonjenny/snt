...
<html>
    ...
    <body bgcolor="#FFFFFF" topmargin=0 leftmargin=0 marginheight=0 marginwidth=0>
        <center>
            ...
            <form name="reqForm" method="post" action="http://devm.shoppingnt.co.kr/contents/2015_t/views/kmc/kmcis_web_sample_step02.jsp">
                <table cellpadding=1 cellspacing=1>
                    ...
                    <tr>
                        ...
                        <td align=left><input type="text" name="tr_url" size="41" value="http://devm.shoppingnt.co.kr/contents/2015_t/views/kmc/kmcis_web_sample_step03.jsp"></td>
                    </tr>
                </table>
                <br><br>
