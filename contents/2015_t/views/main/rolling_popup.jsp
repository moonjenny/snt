...
<div id="popup_wrap_0" class="popup_wrap">
	<div id="popup_box_0" class="popup_box">	
		...
		<div class="roll_inner">
			<div class="rollpop">
				<div>
					<a href="http://m.shoppingntmall.com/plan/planshop/swipeDetail/2017110150?pageType=1" id="link_banner_1" class="link_banner">
						<img src="../../img/_tmp/rollpop01.jpg" alt=""/>
					</a>
				</div>
				<div>
					<a href="http://m.shoppingntmall.com/plan/planshop/swipeDetail/2017110150?pageType=1" id="link_banner_1" class="link_banner">
						<img src="../../img/_tmp/rollpop02.jpg" alt=""/>
					</a>
				</div>
			</div>
			<div class="button_box" id="arrows">
				<div class="btn_wrap">
					<div class="next show"><button class="slick_next">다음<span class="ir_scale">(레이어 팝업)</span></button></div>
					<div class="last"><button id="button_today_close_0" class="button_today_close">오늘은 그만보기<span class="ir_scale">(레이어 팝업)</span></button></div>
				</div>
				<button id="button_popup_close_0" class="button_popup_close">닫기<span class="ir_scale">(레이어 팝업)</span></button>
			</div>
		</div>
		<!--//팝업롤링 배너 2018-04-03-->
	</div>
