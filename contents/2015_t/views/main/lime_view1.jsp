		...
		<div class="wrap_inner"> 
			...
			<main id="contents">
				<section class="mainContents">
					...
					<h2 class="sub_tit"><span>편안한 잠자리를 꿈꾸다</span></h2> -->
					...
					<div class="eventmain">
						...
						<select name="">
							...
							<option value="">상품분류1</option>
							<option value="">상품분류2</option>
							<option value="">상품분류3</option>
                        </select>
					</div>
					<!-- //상품 배너 -->
					<div class="goods_list_wrap">
						<p class="goods_txt">푹신푹신한 메트리스</p>
						...
						<p class="goods_txt">솜털처럼 가벼운 이불</p>
						<div class="goods_wide">
							<div class="goods_img">
