		...
		<div class="wrap_inner">			
			...
			<main id="contents">
				<nav class="gnb main" id="topNav">
					<ul>
						<li class="current"><a>TV쇼핑</a></li>
						<li><a>TV편성</a></li>
						<li><a>오늘의 추천</a></li>
						<li><a>침구/카페트 시즌 OFF</a></li>
						<li><a>이벤트</a></li>
						<li><a>적립금 리필</a></li>
					</ul>
				</nav>
					...
					<div class="swipe-wrap">
						...
						<section class="mainContents" id="homeCont0">
									...
									<div class="with_goods_wrap my_goods_wrap">
										<ul class="goods_list">
											...
											<li>
												<div class="goods">
													<div class="goods_img"><a><img src="../../img/_tmp/001.jpg" alt=""></a></div>
													<div class="goods_name">무방부제 무발색제 싱가포르 화적포 스타일! 너비향 육포 2종 너비향 육포 2종너비향 육포 2종너비향 육포 2종너비향 육포 2종</div>
							...
							<div class="next_goods_wrap goods_wide">
								...
								<div class="goods_cont">
									<p class="goods_name">1+1이벤트 얇은 수분 보호막으로 하루종일 촉촉하게 보호막으로 하루종일 촉촉하게</p>
									<div class="goods">
										<!-- 상품가격 -->
										<div class="goods_price">
											<p class="sell">
							...
							<div class="my_goods_wrap">
								...
								<ul class="goods_list">
									...
									<li>
										<div class="goods">
											<div class="goods_img"><a><img src="../../img/_tmp/001.jpg" alt=""></a></div>
											<div class="goods_name">무방부제 무발색제 싱가포르 화적포 스타일! 너비향 육포 무방부제 무발색제 싱가포르 화적포 스타일! 너비향 육포 2종</div>
							...
							<div class="goods_list_wrap">
								<div class="goods_wide">
									...
									<div class="goods_cont">
										<p class="goods_name">1+1이벤트 얇은 수분 보호막으로 하루종일 촉촉하게 얇은 수분 보호막으로 하루종일 촉촉하게</p>
										<div class="goods">
											<!-- 상품가격 -->
											<div class="goods_price">
												<p class="sell">
...
<!-- pop up -->
<!-- <div id="popup_wrap_0" class="popup_wrap">
	<div id="popup_box_0" class="popup_box">	
		<div class="rollpop">
			<div>
				<a onclick="javascript:urlChange('http://m.shoppingntmall.com/plan/planshop/swipeDetail/2017110150?pageType=1')" id="link_banner_1" class="link_banner">
					<img src="//img.shoppingntmall.com/banner/752/1000752.jpg" alt="" onerror="this.src=&quot;/resources/img/empty/image_W.jpg&quot;">
				</a>
			</div>
			<div>
				<a onclick="javascript:urlChange('http://m.shoppingntmall.com/plan/planshop/swipeDetail/2017110150?pageType=1')" id="link_banner_1" class="link_banner">
		...
		<div class="button_box">
			<button id="button_today_close_0" class="button_today_close"><b>오늘 하루 안보기</b><span class="ir_scale">(레이어 팝업)</span></button>
			<button id="button_popup_close_0" class="button_popup_close"><b>닫기</b><span class="ir_scale">(레이어 팝업)</span></button>
		</div>
	</div>
</div> -->
<!--2018-02-23 추가팝업-->
<div id="popup_wrap_0" class="popup_wrap">
	<div id="popup_box_0" class="popup_box">
<div class="appdownpop">
	<p><img src="http://img.shoppingntmall.com/htmleditor/332/event_20180530011527646637287.png" alt=""></p>
	<a onclick="javascript:urlChange('http://m.shoppingntmall.com/plan/event/swipeDetail/2018030282?pageType=1')"><img src="http://img.shoppingntmall.com/htmleditor/666/event_20180530021527646800565.png" alt="적립금 받으러 가기"></a>
	<a href="#" id="button_today_close_0"><img src="http://img.shoppingntmall.com/event/201803/appdownWeb_04.png" alt="모바일 웹에서 계속 쇼핑하기"></a>
</div>
	</div>
</div>
<!--//2018-02-23 추가팝업-->
...
var doubleClick = 0;
function provideCoupon(couponNo){
    var parObj = new Object();
	
	if(comUtil.isEmpty(couponNo)){
	    alert("쿠폰 발급 실패");
		return;
	}
	
    parObj['mediaCode'] = "";
    parObj['couponNo']  = couponNo;
    ...
    commonJsonAjax("/customer/provide-coupon", parObj, 'json', 'POST')
    .done(function(data, textStatus, jqXHR){
        if("200" == data.data.code) {
            alert("쿠폰 발급이 완료되었습니다.");
            doubleClick = 0;
        } else {
            if("401" == data.data.code) {
                checkLogin("/index");
            } else {
